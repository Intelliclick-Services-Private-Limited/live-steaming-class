...
module.exports = {
    ...
    ui: {
        ...
        brand: {
            ...
            app: {
                ...
                joinDescription: process.env.JOIN_DESCRIPTION || 'Pick name.<br />How about this one?',
            ...
            site: {
                ...
                newRoomTitle: process.env.NEW_ROOM_TITLE || 'intelliclick <br />Share URL. <br />hello.',
                newRoomDescription:
    ...
    features: {
        ...
        stats: {
            ...
            src: process.env.STATS_SRC || '../public/js/script.js',
